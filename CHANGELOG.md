...
## [v1.13.4](https://github.com/alan-wu/flatmapvuer/compare/v1.13.3...v1.13.4)

### Merged

- Change alert label to notes [`#337`](https://github.com/alan-wu/flatmapvuer/pull/337)

### Commits

- Update map-utilities [`5479fbc`](https://github.com/alan-wu/flatmapvuer/commit/5479fbc4b34c3cf5c4d03943a20b702065c67948)
- Update tests for changing alert to notes [`64fe251`](https://github.com/alan-wu/flatmapvuer/commit/64fe25174c649226890831068698a6d258885098)

## [v1.13.3](https://github.com/alan-wu/flatmapvuer/compare/v1.13.2...v1.13.3) - 2026-05-18

### Merged

- Remove duplicate terms for connectivity info [`#335`](https://github.com/alan-wu/flatmapvuer/pull/335)
- Fix alert data type [`#333`](https://github.com/alan-wu/flatmapvuer/pull/333)

## [v1.13.2](https://github.com/alan-wu/flatmapvuer/compare/v1.13.1...v1.13.2) - 2026-05-07

### Merged

- Update alert labels to notes [`#329`](https://github.com/alan-wu/flatmapvuer/pull/329)
- Remove debug log [`#330`](https://github.com/alan-wu/flatmapvuer/pull/330)

### Commits

- Update map-utilites. [`78ad9b1`](https://github.com/alan-wu/flatmapvuer/commit/78ad9b1a4959b7c9d6bfa48fb20cea2c46f0bf52)

## [v1.13.1](https://github.com/alan-wu/flatmapvuer/compare/v1.13.0...v1.13.1) - 2026-03-30

### Commits

- Update map-utilities. [`f0cec2e`](https://github.com/alan-wu/flatmapvuer/commit/f0cec2e99d814120e70458c5c5437b698445fcb3)

## [v1.13.0](https://github.com/alan-wu/flatmapvuer/compare/v1.12.2...v1.13.0) - 2026-03-19

### Merged

- Single listing with SCKAN as the primary listing [`#326`](https://github.com/alan-wu/flatmapvuer/pull/326)

### Commits

- Update to use demo package. [`fd33e04`](https://github.com/alan-wu/flatmapvuer/commit/fd33e04cd741498b82e405a312b9ff2990a226bb)
- Add single connectivity combination in connectivity list data [`ec222dc`](https://github.com/alan-wu/flatmapvuer/commit/ec222dcec8b444b39b62d38e6104ff9e5a750e52)
- Update connectivity single combination listing [`8959249`](https://github.com/alan-wu/flatmapvuer/commit/8959249be7afcda33754cdf3b5a613535309a5d9)

## [v1.12.2](https://github.com/alan-wu/flatmapvuer/compare/v1.12.1...v1.12.2) - 2026-01-16

### Merged

- Change Network Connection Mode to show only forward and backward connections when clicking on neuron populations [`#323`](https://github.com/alan-wu/flatmapvuer/pull/323)

### Commits

- Open connectivity info for paths click on all viewing modes [`15eafe2`](https://github.com/alan-wu/flatmapvuer/commit/15eafe2c71cdc8de5ece21e25f6c4a365b57640e)
- Update src/components.d.ts. [`05f8ecb`](https://github.com/alan-wu/flatmapvuer/commit/05f8ecb934d4eabc756ec3adf1f4cc553148bf8b)

## [v1.12.1](https://github.com/alan-wu/flatmapvuer/compare/v1.12.0...v1.12.1) - 2025-12-01

### Merged

- Update GL context lost message. [`#321`](https://github.com/alan-wu/flatmapvuer/pull/321)
- Upgrade flatmap-viewer to 4.4.3. [`#322`](https://github.com/alan-wu/flatmapvuer/pull/322)
- Add borderStyle property, defaulting to default if not set. [`#320`](https://github.com/alan-wu/flatmapvuer/pull/320)

### Commits

- Add a small tolerance for test flatmap visual test.. [`d498e8a`](https://github.com/alan-wu/flatmapvuer/commit/d498e8a03742f16bd926ad6ff7ef58d9e2364624)
- Fix an issue with the border in the legends. [`299d264`](https://github.com/alan-wu/flatmapvuer/commit/299d2640aaa270a333f9c260d5b37a9b7447e678)
- Add borderStyle property, defaulting to solid if not set (#319). [`5d49836`](https://github.com/alan-wu/flatmapvuer/commit/5d49836df872e52bdd77997888a0f336fb55389f)

## [v1.12.0](https://github.com/alan-wu/flatmapvuer/compare/v1.12.0-beta.1...v1.12.0) - 2025-11-04
